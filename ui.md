...
# ProxyZero Dashboard Design System

## Overview

ProxyZero menggunakan futuristic dark SaaS dashboard aesthetic dengan kombinasi:
...
# Interactive Model Popup System

# Overview

Semua model card wajib clickable.

Ketika user klik card:
- popup/modal muncul
- data model harus mengikuti card yang dipilih
- modal menggunakan style futuristic dark
- animasi smooth fade + scale
- backdrop blur aktif

Popup berfungsi sebagai:
- model detail viewer
- playground test
- realtime model interaction panel
...
## ui pop up card model yg tidak free 

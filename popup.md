from sesuiakan dengan sistem contoh 

local :sesuai ip lokal nya http://localhost:20129/v1

tunel : sesuai dengan claoflare tunel tanpa domain 

model : sesuai dengan model yg di klik card nya 
